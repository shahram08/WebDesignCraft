...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // اگر خطایی وجود نداشت، تلاش برای ثبت‌نام
    if(empty($errors)) {
        $user = new User();
        ...
        if($result['success']) {
            ...
            if($login_result['success']) {
                // تنظیم پیام موفقیت
                set_flash_message('success', 'ثبت‌نام شما با موفقیت انجام شد. خوش آمدید ' . $_SESSION['user_name'] . '!');
                
                // هدایت به صفحه مناسب
                redirect(url('dashboard/'));
            } else {
                // تنظیم پیام موفقیت و هدایت به صفحه ورود
                set_flash_message('success', 'ثبت‌نام شما با موفقیت انجام شد. لطفا وارد شوید.');
...
<head>
    ...
    <title>ثبت‌نام در سایت - <?php echo SITE_TITLE; ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex">
                    ...
                    <a href="<?php echo url('register.php'); ?>" class="btn btn-primary active">ثبت‌نام</a>
                </div>
            </div>
        </div>
    </nav>
                ...
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5">
                            <h1 class="card-title text-center mb-4">ثبت‌نام در سایت</h1>
                            ...
                            <form id="registerForm" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="needs-validation" novalidate>
                                <div class="mb-3">
                            ...
                            <div class="text-center mt-4">
                                <p>قبلاً ثبت‌نام کرده‌اید؟ <a href="<?php echo url('login.php'); ?>">وارد شوید</a></p>
                            </div>
                        </div>
                    </div>
                </div>
